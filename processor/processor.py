...
class Processor(IO):
    ...
    def load_data(self):
        ...
        if self.arg.phase == 'train':
            self.data_loader['train'] = torch.utils.data.DataLoader(
                ...
                shuffle=True,
                num_workers=self.arg.num_worker * torchlight.torchlight.ngpu(
                    self.arg.device),
                drop_last=True)
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--use_gpu', type=str2bool, default=None, help='use GPUs or not')
        ...
        # feeder
        parser.add_argument('--target_names', default=None, help='target_names')
